...
import 'passenger_first_page_f_model.dart';
export 'passenger_first_page_f_model.dart';

class PassengerFirstPageFWidget extends StatefulWidget {
  const PassengerFirstPageFWidget({super.key});

  static String routeName = 'PassengerFirstPageF';
  static String routePath = '/passengerFirstPageF';

  @override
  State<PassengerFirstPageFWidget> createState() =>
      _PassengerFirstPageFWidgetState();
}

class _PassengerFirstPageFWidgetState extends State<PassengerFirstPageFWidget>
    with TickerProviderStateMixin {
  late PassengerFirstPageFModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PassengerFirstPageFModel());
    ...
    _model.passengerNameTextController1 ??= TextEditingController();
    _model.passengerNameFocusNode1 ??= FocusNode();
    ...
    _model.passengerNameTextController2 ??= TextEditingController();
    _model.passengerNameFocusNode2 ??= FocusNode();
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .passengerNameTextController1,
                                                        focusNode: _model
                                                            .passengerNameFocusNode1,
                                                        autofocus: true,
                                                        autofillHints: [
                                                          AutofillHints.name
                                                        ],
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .passengerNameTextController2,
                                                      focusNode: _model
                                                          .passengerNameFocusNode2,
                                                      onChanged: (_) =>
                                                          EasyDebounce.debounce(
                                                        '_model.passengerNameTextController2',
                                                        Duration(
                                                            milliseconds: 2000),
                                                        () async {
                                                          safeSetState(() {
